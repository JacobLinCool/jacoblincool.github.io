...
export type GitHubCatalogRepository = {
    fullName: string;
    name: string;
    url: string;
    description: string;
...
export type HuggingFaceUserSummary = {
    author: string;
    models: number;
    spaces: number;
...
export type HuggingFaceModelDetail = {
    id: string;
    downloads: number;
    likes: number;
    pipelineTag: string | null;
...
export type HuggingFaceSpaceDetail = {
    id: string;
    likes: number;
    sdk: string | null;
    lastModified: string | null;
...
const createGithubClient = (fetchFn: FetchLike, config: ProviderRuntimeConfig) =>
    new Octokit({
...
export const fetchHuggingFaceUserSummary = async (
    ...
    config: ProviderRuntimeConfig,
    timeoutMs: number
): Promise<HuggingFaceUserSummary> => {
...
export const fetchHuggingFaceSpaceDetail = async (
    ...
    spaceId: string,
    timeoutMs: number
): Promise<HuggingFaceSpaceDetail> => {
