import { z } from 'zod';
import knowledgeGraphSource from '../../assets/knowledge.graph.json';
import knowledgeItemsSource from '../../assets/knowledge.items.json';
import siteUiSource from '../../assets/site-ui.json';
...
export const loadStaticKnowledgeContent = (): StaticKnowledgeContent => staticKnowledgeContent;

export const getStaticKnowledgeRegistry = (): KnowledgeRegistry => staticKnowledgeContent.registry;

export const getStaticSiteUiConfig = (): SiteUiConfig => staticKnowledgeContent.siteUi;

export const collectDescendantItemIds = (
    registry: KnowledgeRegistry,
    rootNodeId: string
): string[] => {
...
export const countDescendantItems = (registry: KnowledgeRegistry, rootNodeId: string): number =>
