<template>
    <div id="app">
        <transition name="fade" mode="out-in">
            <div v-show="true" id="main-menu-button" @click="menu_open = !menu_open">
                <i class="fas fa-bars" style="font-size: 36px; color: #cdd9e2"></i>
            </div>
        </transition>
        ...
        <transition name="fade" mode="out-in">
            <div v-show="menu_open" class="menu-barrier" @click="menu_open = false"></div>
        </transition>
        <transition name="fade" mode="out-in">
            <router-view />
        </transition>
